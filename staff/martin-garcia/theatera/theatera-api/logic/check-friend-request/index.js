...
module.exports = function(emiterId, receiverId) {
    ...
    return (async() => {
        ...
        if (!repeatedFriendRequest && !reciprocalFriendRequest) {
            ...
            const noti = new Notification({ body: { message: "friendRequest", name: emiter.name,introduction:emiter.introduction, image: emiter.image, id: emiter.id, type: 'CONNECTION', date: new Date } })
